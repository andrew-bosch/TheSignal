...
3. **The center is always relevant.** The Chorus Node's strategic incentives — Chorus Activity suppression, Chorus Portrait multiplier, Chorus Question access — ensure it remains a contested objective throughout the session regardless of its lack of resource output.
...
**Chorus Portrait Multiplier:** The faction holding Dominant influence at the Chorus Node has all their actions receive ×1.25 Chorus Portrait magnitude this round. ARBITER records privately. Not available during Contested condition.

**Chorus Question Access:** Only factions with at least Present influence (including operational marker) at the Chorus Node may propose a Chorus Question when the window opens.
...
Full influence level rules and all Contested examples are specified in Artifact 02 — Resource Systems.
