...
| 00a | Governing Rules & Design Policy | 0.3 | ⚠️ Pending Re-Sign-Off — S38 (R39 added) | 42 rules. R39 (S38): each covert operation requires one Dispatch Token; no token = invalid at Beat 0; political acts exempt; allocation drawn from The Backlog (standard: 3, Ghost: 4). Previously: 41 rules (R01–R38 + R13a, R13b, R29a), §3–§9, Appendix A. |
...
| PM05 | Active Punch List | 2.5 | 🔄 Active | Living action queue of all pending changes across all artifacts. Session 33: 00-07 added. S37: 04-41 closed (Intel universal currency, L148); 04-47 added (Intel economy cards schema pass); 04-48 added (Art 03 v1.9 re-sign-off). |
