...
| 00a | Governing Rules & Design Policy | 0.4 | 🔄 Pending Re-sign-off — S67 (L187, L188) | 46 rules (R01–R40 + R06a, R13a, R13b, R29a, R29b, R40a). S67: 00-R40 added (L187); 00-R06a + 00-R40a added (L188); R40 relocated §9→§3. Pending re-sign-off. S38: R39 (Dispatch Tokens). S40: stale migration notes removed; §11 Punch List removed; R38 fix. S57: 00-R30 added (Missing Author Vacuum; L177). S61: 00-R21 updated (4-type duration taxonomy — Immediate/Transient/Seasonal/Permanent); 00-R22 rewritten (partial payment model — full/partial/zero thresholds); 00-R29b added (Missing Author Vacuum — renamed/renumbered from duplicate 00-R30); 00-R39 revised (covers both covert ops and public acts). Signed off v0.4 (L182). |
