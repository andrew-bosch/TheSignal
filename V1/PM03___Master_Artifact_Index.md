...
| 03 | Round Structure & Gameplay | 1.9 | ⚠️ Pending Re-Sign-Off — S37 | S37: Double Case Pass architecture — Quarter restructured into Month 1/2 (covert) + Month 3 (political). Dispatch Tokens (3/faction, 4/Ghost). Intel Token Decay at Upkeep (Step 6). Ghost Political Act token gate (L147). Sections renumbered §9–§17; §18–§22. Previously: Seven phases. §19 Operation System (d100, modifiers M-01–M-12, L108-compliant table). |
