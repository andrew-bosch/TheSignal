...
| 04 | Card System | 0.9.16 | 🔄 In Progress | Session 28: §6 schema cleanup (enum values Constraints → Notes; Crit constraints tightened to "N/A if Resolution = Automatic"); Pass cards redesigned — 4 named variants PS-01–PS-04 (L137); taxonomy exclusions locked (L138); faction-specific design notes expanded (C18, C21, C28); Syndicate gap concepts added; §12 rewritten. C01–C15 re-sign-off pending (04-23). Political acts P01–P18 pending. |
