...
| 03-init | Game Initialization | 0.4 | 🟡 In progress — §2.8 Broadcast Deck/Effect Deck rows added; §3.9 deck list updated. Remaining: card decks (Art 04 §12), Classified Directives (Art 06.x). |
