...
| 04 | Card System | 0.9.9 | 🔄 In Progress | Covert operations C01–C15 signed off. Session 26 §6 schema overhaul: renamed "Card Data Schema"; Type column added (String/Semver/Integer/Enum/Prose/±Integer); Constraints cleaned to pure validation rules (L108-informed); Portrait unified table (Faction\|Flat\|Submitter\|Condition\|Modifier\|Mod Condition) replacing split Flat+Submitter structures; Design note formalized as Taxonomy field; Faction constraint updated to [faction] != ARBITER. C01/C02 Portrait Flat set (Guild ±1); Option A confirmed (board-state effect = Flat, not Submitter). Political acts and faction-specific cards C16–C35 pending review. |
