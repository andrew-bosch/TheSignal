...
| 00c | Economy Manifest | 0.4 | ⚠️ Future Analysis Stub — Not Canonical | Not an active reference. Do not cite for design decisions or ref files. Future economic calibration index — will aggregate resource generation rates, operation costs, and modifier thresholds from source artifacts for balance/playtesting use. Canonical sources: Art 02, Art 03, Art 04. Content is partially populated and may be stale. §3 Starting Assets, §4 Resource Generation Rates, §6 Operation System partially populated (source versions 02a v1.4 / 02b v1.5 / 03 v1.7 — stale). §5 Card Costs, §8 Derived Cost Analysis, §9 Round Income Analysis blocked pending Art 04 completion. |
