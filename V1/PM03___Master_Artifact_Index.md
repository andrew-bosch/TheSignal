...
| 03a | Game Engine Specification | 0.97 | 🔄 In Progress — Layers 1–3 drafted | Code-lite technical companion to Art 03. Layer 1 (State Model): formal game state at each beat boundary using 00b entity IDs. Layer 2 (Beat Procedures): Beat_0()–Beat_5() pseudocode with IF/THEN/ELSE branches, modifier stack as summation formula, resolution check as formal inequality. Layer 3 (Decision Tables): DT-01–DT-09 covering card face determination, Apex, Critical overrides, partial payment, Infrastructure (L107), Type B scope, Emergency Response assist/thwart; Apex_Activation() procedure. Layer 4 stub (modifier balance analysis) in §9 — blocked on Art 04 card definitions. Variable modifier rows M-08/M-09/M-10 pending Art 04. |
...
| PM02 | Decision Log & Validation Tracker | 2.1 | 🔄 Active | Locked decisions (L01–L114), open blocking decisions, playtest variables. §2b punch list archived — live version in PM05. Change log through session 22. |
