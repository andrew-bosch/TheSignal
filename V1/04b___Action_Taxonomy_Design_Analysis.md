...
**Standard set:** Audited in full at S120 (`Retired/Whiteboard_Archive/card_analysis_STD_GHO.md`; condensed summary: `Retired/Whiteboard_Archive/card_analysis_summary_S119-128.md`). Results unchanged — all five faction native types have STD spending destinations; no unspendable acquired resources. ✓
