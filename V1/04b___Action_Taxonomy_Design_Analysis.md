...
3. **SYN.MOD.1 Accord Leverage — full spec:** Currently a stub (procedure, party requirement, scope, ID all TBD). Required for Accord manipulation suite to be complete. Gate: 04-n28 (Accord design substantially complete S69).
