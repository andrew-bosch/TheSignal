...
**Resources** are the five materials that fund all actions. They are generated by the board state each quarter, held publicly, and spent on covert operations and political acts. Ghost's resource, Findings, decays if not spent.
...
| Ring | Base Value |
|------|-----------|
| Sprawl | 1 unit per quarter |
| Infrastructure | 2 units per quarter |
