...
| 03-09 | **Apex activation vs. Beat 0 — design conflict (L103).** Resolved: L104 (session 19). Beat 0 silent note; Beat 3 queue trigger; resources non-refundable; Apex success suspends and fails remaining ops. §15 and §16 updated. Affects Artifact 05 (Apex rules cross-reference). | Material (design decision) | L103, L104 | ✅ Session 19 |
