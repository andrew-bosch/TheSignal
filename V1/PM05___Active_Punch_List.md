...
| 03-03 | Declaration phase updated — free Accord card from C09 Fund is ARBITER-delivered, not drawn from political deck. Applied in v1.5. Requires sign-off. **Current text (Phase 4 Declaration Rules):** "A free Accord card may be declared this round if triggered by C09 Fund resolution — this does not consume a card from the political draw deck; The ARBITER Player delivers the Accord card directly." Session 14: Phase 4–end scan complete. L99 non-material fixes applied (Beat 3 Step 9, Beat 4 Steps 7–8, Apex Steps 1–5). D03-R03 is the last gate before full Artifact 03 sign-off. | Material | L51, D03-R03 | 🔄 Awaiting sign-off — text in place, ready for Andy's review |
