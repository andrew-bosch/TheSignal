...
~~**Net ledger vs power tier (04-n236, S160)**~~ — **CLOSED by ruling (L376): the tier is gross effect delivered.** Recorded as governing in Art 00c §5, which had never stated what `value_rating` means — the omission is what allowed the net-ledger measure to be wired in at all. Under gross the CA/PA corpus reads **zero drift**.
