...
`card_body` (16,175 rows — EAV mirror of every `Card()` field, added S156), `card_restriction_clause` (117 rows — `restriction` decomposed to subject/op/value, S156), `card_checklist` (6,970 rows, S155), `card_effect_component` (355 rows — outcome fields decomposed into priced units; extractor added S157).
