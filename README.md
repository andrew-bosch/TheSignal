...
**Design milestone:** S145 — `value_rating` (1–4) definition locked and applied corpus-wide (04-n178/04-n183 closed). 164 cards tiered via natural-break on `total_pair_cost` (pyramid: <3.0→1, 3.0–4.99→2, 5.0–6.99→3, ≥7.0→4); 27 ring-modifier cards matched via S132/S134 magnitude-mirror convention; 9 overridden to pricing-model tier on Andy's call; 8 remain unaddressed (blocked/TBD cards). Along the way: `GHO.PA.1`/`STD.PA.5` taxonomy-corrected and repriced; `GHO.PA.1` cost restructured (8.00→10.00 effective), locked as intentional Ghost doctrinal advantage; `STD.PA.5` threshold 35→30. UVM caveat documented everywhere needed: base rates calibrated by averaging existing card costs, not playtested — added to schema_reference.md §6.7, cost_baseline_recommendations.md, design_reference_card_system.md, and project_db_design_intent.md memory. New PM05 04-n184 (deck copy-count/draw-probability) gated on per-faction/cross-faction audit redo, not standalone. Full detail PM02 L283/L284. Next: audit per-faction card space (S119–128 style), then tackle deck copy-count. Prior (S144): S143 outlier checklist closed (6 cards repriced/confirmed). Prior (S143): Floor Act designed; UVM pipeline built. Prior (S142): 09-16 step 2 PA design review complete (45 cards, all 6 sets). Prior (S141): CA design review complete (69 cards). Prior (S140): ModBattleCard review complete (44 cards).
...
| # | Artifact | Ver | Status |
|---|----------|-----|--------|
| 04 | [Card Set: Action Subroutines](V1/04___Card_System___Part1_Core.md) | 0.9.88 | 🔄 In progress — S145: `value_rating` (1–4) definition locked and applied corpus-wide (04-n178/04-n183 closed). 164 cards tiered via natural-break on `total_pair_cost` (pyramid: <3.0→1, 3.0–4.99→2, 5.0–6.99→3, ≥7.0→4); 27 ring-modifier cards matched via S132/S134 magnitude-mirror convention; 9 overridden to pricing-model tier on Andy's call; 8 remain unaddressed (blocked/TBD cards). `GHO.PA.1`/`STD.PA.5` taxonomy-corrected and repriced; `GHO.PA.1` cost restructured (8.00→10.00 effective), locked as intentional Ghost doctrinal advantage. UVM caveat documented: base rates calibrated by averaging existing card costs, not playtested — added to schema_reference.md §6.7, cost_baseline_recommendations.md, design_reference_card_system.md. New PM05 04-n184 (deck copy-count/draw-probability) gated on S119–128 audit redo. Full detail PM02 L283/L284. Prior — S144: S143 outlier checklist closed (6 cards repriced/confirmed). Prior — S143: Floor Act designed; UVM pipeline built; outlier review surfaced needs. Prior — S142: PA review complete (45 cards). Prior — S141: CA review complete (69 cards). |
