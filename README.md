...
**Design milestone:** S154 — MILESTONE: full 385-card Art 04 corpus now has a genuine Design Pass (Directorate/Network/Syndicate/Ring Modifiers closed, completing the 6-set program begun S138). New locked authoring rule: a finished Card() carries zero inline comments and no arbiter_note — 4,685 boilerplate comments stripped corpus-wide, 279 cards' procedure-support claim corrected, redundancy triage cut that to a genuine 95-card Art 03 procedure-gap backlog (PM05 04-n221). card_status DB fully synced. Art 04 → 0.9.93. PM02 L350–L351. Prior (S153): Whiteboard consolidation and hygiene sweep, Reference/ directory created, Schema Cleanup Program closed (04-n191, 04-n198), cost_baseline_recommendations.md migrated to Art 00c §5. Art 04 (0.9.92) and Art 00c (0.5) versions synced. PM02 L349.
...
| # | Artifact | Ver | Status |
|---|----------|-----|--------|
| 04 | [Card Set: Action Subroutines](V1/04___Card_System___Part1_Core.md) | 0.9.93 | 🔄 In progress — S154: MILESTONE — full 385-card corpus now has a genuine Design Pass (Directorate/Network/Syndicate/Ring Modifiers closed). New locked authoring rule: a finished Card() carries zero inline comments and no arbiter_note. 4,685 boilerplate comments stripped corpus-wide; 279 cards' "Supported by game procedure" row corrected, 117 Issues Resolved reverted; redundancy triage found 174 of those notes were pure duplication (removed, 76 re-qualified for Issues Resolved), leaving a genuine 95-card Art 03 procedure-gap backlog (PM05 04-n221). card_status DB fully synced (was 0/0 across all 386 rows). Full detail PM02 L350–L351. Prior — S150: schema_cleanup_log synthesis items #4 and #20 fully closed. New DB column card_status.mod_subtype + view v_card_taxonomy_gaps. New Art 03 §7.4 Resource Type rule and §18 tiebreak refinement; new Art 00a GR §7.2c (Triggering Conditions Are Exhausted on Resolution). Art 03 (v4.15) and Art 00a (v0.13) re-signed off. New §6.3 vocabulary. Full detail PM02 L339–L345. Prior — S149: Schema Cleanup Phases 3–4 closed (PM05 04-n191, PM02 L327–L332). Phase 3: legacy-vocabulary card fixes (4 of 7), Phase 4: TriggerExpr schema additions + decision-batch rulings (9 of 12). §6.3 gained `ring=`, `uses_intel_token=`, `board_state.changed()` vocabulary. Art 03 §18.2.2 added (React default removal). Hygiene recurrence #6 swept. |
