...
def main():
    ...
    lines = []
    lines.append("| Ring | Address | Origin # | Origin District | Adjacent Address | Adjacent # | Adjacent Ring | Allow Ingress | Allow Egress |")
    lines.append("|------|---------|---------|----------------|-----------------|-----------|--------------|--------------|-------------|")
    ...
    for origin in origin_order:
        ...
        for n in neighbors:
            ...
            n_addr = addresses[n]
            lines.append(f"| {o_ring} | {o_addr} | {origin} | {o_name} | {n_addr} | {n} | {n_ring} | TRUE | TRUE |")
