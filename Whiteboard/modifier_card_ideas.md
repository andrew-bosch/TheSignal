...
## ModBattleCard / ModActionCard Design Principles (S132/S135) — Fully Shipped

Both design-principle write-ups that lived here are now fully realized as shipped content, not standing design analysis. ModBattleCard: 20 faction cards (all 5 factions) + 24 ring cards (all 3 rings), locked format 2 Boost/2 Hinder per set. ModActionCard: 60 faction cards + 72 ring cards, locked format 4 threshold_delta + 2 success_multiplier + 4 ps_shift + 2 cost_reduction per set. Full principle text, per-faction/per-ring breakdowns, and the mid-session corrections (ps_shift matrix, threshold_delta tier count, value_rating widening) archived at `Retired/Whiteboard_Archive/modifier_card_seeds_and_principles_S132-S135.md`. Canonical content: Art 04 §7. Decision history: PM02 L242, L256–L261; PM05 09-06, 04-n157, 04-n170.
...
- Hostile-flavored ModAction seed entries need self-only reframe or drop before stubbing (PM05 04-n170)

---

*See PM05 items: 04-n4 (S58 architecture), 04-56 (deck types), 04-49 (battlefield modifier), XA-35 (assets rename), 04-29 (geography principle — closed S134), 04-52 (token disposition), 04-n157 (ModActionCard action-space analysis — closed S135), 04-n170 (self-only reframe flag)*

---

## Modifier Card Seed Pools (S134) — Fully Consumed S135

All three seed pools that lived here (Ring ModAction, Faction ModAction, Ring ModReact) are fully drawn from — every card is shipped in Art 04 §7 (60 faction + 72 ring ModActionCard, 20 faction + 24 ring ModBattleCard, 36 ring ModReactCard). Full pool text, reframing notes, and per-card provenance archived at `Retired/Whiteboard_Archive/modifier_card_seeds_and_principles_S132-S135.md`. Canonical content: Art 04 §7. Decision history: PM02 L242, L256–L265; PM05 09-06, 04-n157, 04-n170, 04-n171, 04-53.
